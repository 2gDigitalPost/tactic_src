...
INSERT INTO pref_list ("key", description, options, "type", category, title) VALUES ('quick_text','Quick VARCHAR(MAX) for Note Sheet','','string','general','Quick Text');
