...
spt.md5 = function(str1)
{
  ...
  var convertToWordArray = function (str27) {
    var lWordCount;
    var lMessageLength = str27.length;
    ...
    while (lByteCount < lMessageLength) {
      ...
      lWordArray[lWordCount] = (lWordArray[lWordCount] | (str27.charCodeAt(lByteCount) << lBytePosition));
      lByteCount++;
    }
    lWordCount = (lByteCount - (lByteCount % 4)) / 4;
    lBytePosition = (lByteCount % 4) * 8;
...
spt.undo_cbk = function(evt, bvr)
{
    ...
    var pass_md5 = spt.md5(pass);
    if(pass_md5 == 'a2ad4166a3b02a9d9b17bad2f3664491'){
        ...
        alert('I actually need the correct password...');
    }
